<div class="border-bottom d-flex justify-content-between py-3">
    ...
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="modalTambah">
      <i class="bi bi-plus"></i> Tambah Pemasok</button>
    <!-- Modal -->
  <div class="modal fade" id="ModalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <div class="mb-3">
        ...
        <input class="form-control" type="text" name="alamat" placeholder="Masukkan almat" required>
      </div>
      <div class="mb-3">
...
?>
    <tr>
      ...
      <td>
        <a href="" data-bs-toggle="modal" data-bs-target="#modalEdit<?=$row_pemasok['id_pemasok'];?>" class="text-info"><i class="bi-pencil-square"></i></a>
            ...
            <div class="modal-content">
              ...
              <form action="modul/pemasok/proses.php?aksi=edit&id=<?=$row_pemasok['id_pemasok'];?>" method="post">
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                    <label class="form-label" for="telepon">Telepon</label>
                    <input ckass="form-control" type="text" name="telepon" placeholder="Masukkan telepon" value="<?= $row_pemasok['telepon'];?>" required>
                  </div>
                  <div class="mb-3">
                    <label class="form-label" for="status">Status</label>
                    <select class="form-select" name="status">
        ...
        <div class="modal fade" id="modalHapus<?= $row_pemasok['id_pemasok'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                Apakah anda yakin ingin menghapus data pemasok <?= $row_pemasok['nama_pemasok'];?>? 
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
