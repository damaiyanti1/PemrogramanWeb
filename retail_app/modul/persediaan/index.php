...
<div class="border-bottom d-flex justify-content-between py-3">
    ...
    <button class="btn btn-primary" data-bs-toggle="modal" data-bd-target="#modalTambah"><i class="bi bi-plus"></i> Tambah Persediaan</button>
         <!--Modal-->
            ...
            <tr>
                ...
                <td>
                    <a class="text-decoration-none" href="" data-bs-toggle="modal" data-bs-target="#modalMasuk<?= $row_persediaan['id_persediaan'];?>">
                        <i class="bi bi--clipboard1-pluss-fill"></i>
                    </a>
                       <!--Modal-->
