<div class="border-bottom d-flex justify-content-between py-3">
  ...
  target="#modalTambah"><i class="bt bi-plus"></i> Tambah Barang</button>
</div>
<!-- Modal -->
<div class="modal fade" id="modalTambah" tabindex="-1" aria-
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <select class="form-select" name="pemasok" required>
              ...
              ?>
              <option value="<?= $row_pemasok['id_pemasok']; ?>">
                <?= $row_pemasok['nama_pemasok']; ?></option>
              <?php
              }
              ?>
            </select>
...
<div class="mb-3">
<label class="form-label" for="harga_belt">Harga Beli</label>
<input type="number" name="harga_belt" class="form-control" placeholder="Contoh: 5000" required>
</div>
<div class="mb-3">
    ...
    <tr>
        ...
        <td>
            ...
            <select class="form-select" name="pemasok" required>
                ...
                while($row_pemasok = $result_pemasok->fetch_assoc()){
                ?>
                    <option value="<?= $row_pemasok['id_pemasok'];?>" <?= $row_barang['id_pemasok'] == $row_pemasok['id_pemasok'] ? 'selected' : ''; ?>>
...
<div class="mb-3">
    <label class="form-label" for="harga_jual">Harga Jual</label>
    <input type="number" name="harga_jual" class="form-control" placeholder="Contoh : 7000" value="<?= $row_barang['harga_jual']; ?>" required>
</div>
<div class="mb-3">
    <label class="form-label" for="deskripsi">Deskripsi</label>
    <input type="text" name="deskripsi" class="form-control" placeholder="Contoh : Barang baru" value="<?= $row_barang['deskripsi_barang']; ?>" required>
</div>
<div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
